...
export default function SaleSection() {
    ...
    const collectionSchema = {
        ...
        "@type": "CollectionPage",
        "name": "Luxury Residential Properties for Sale in Navi Mumbai",
        "description": "Browse our curated list of RERA verified luxury residential properties and villas for sale across Navi Mumbai's prime locations.",
        "url": "https://navimumbaipropertydeals.com/sale",
        "mainEntity": {
            "@type": "ItemList",
    ...
    return (
        <section className="py-16 bg-[#fdfdfd] overflow-x-clip relative" aria-labelledby="sale-section-heading">
            <script
                ...
                <div className="flex flex-col items-center justify-center gap-8 relative z-10 w-full mb-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-brand-primary font-bold tracking-wider uppercase text-[13px] max-[426px]:text-[12px]">Luxury Properties</span>
                        </motion.div>

                        <h2 id="sale-section-heading" className="text-6xl max-[769px]:text-5xl max-[426px]:text-4xl max-[376px]:text-3xl max-[321px]:text-2xl font-extrabold text-brand-heading leading-[1.15] tracking-tight mb-6 flex flex-col items-center">
                            <span>Exclusive Residential Property</span>
                        ...
                        <p className="text-brand-paragraph text-[17px] md:text-lg font-medium leading-relaxed max-w-4xl mx-auto">
                            Browse Handpicked luxury residential real estate listings available for purchase in Kharghar, Vashi, and prime Navi Mumbai nodes. Effortlessly scroll to find spaces that perfectly match your lifestyle and budget.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="relative group">
                    ...
                    >
                        {properties.map((property, index) => {
                            const propertyTitleId = `sale-title-${property.id}`;
                            return (
                                <motion.div
                                    key={property.id}
                                    ...
                                    >
                                        ...
                                        <div className="px-5 pb-5 pt-3 flex-1 flex flex-col justify-between bg-white z-20 relative">
                                            ...
                                            <button
                                                ...
                                                aria-label={`View detailed property insights for ${property.title}`}
                                                title={`View detailed property insights for ${property.title}`}
                                            >
