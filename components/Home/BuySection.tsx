...
import { MapPin, BedDouble, Bath, Maximize, ArrowRight, Heart, ChevronLeft, ChevronRight, Sparkles } from "lucide-react";
...
export default function BuySection() {
    ...
    return (
        <section className="py-16 bg-[#fdfdfd] overflow-x-clip relative">
            {/* Background Decorative Elements - Refined for Professional feel */}
                ...
                <div className="flex flex-col items-center justify-center gap-8 relative z-10 w-full mb-8">
                    ...
                    >
                        ...
                        <h2 className="text-6xl max-[769px]:text-5xl max-[426px]:text-4xl max-[321px]:text-3xl font-extrabold text-brand-heading leading-[1.15] tracking-tight mb-6 flex flex-col items-center">
                            <span>Explore Exclusive Spaces</span>
                            <span className="relative inline-block mt-2">
                                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-primary-hover drop-shadow-sm">Available For Buy</span>
                                <motion.div
                                    initial={{ scaleX: 0 }}
                        ...
                        <p className="text-brand-paragraph text-[17px] md:text-lg font-medium leading-relaxed max-w-4xl mx-auto">
                            Handpicked premium real estate listings available for purchase in Navi Mumbai. Effortlessly scroll to find spaces that perfectly match your lifestyle and budget.
                        </p>
                    </motion.div>
                </div>
            </div>
